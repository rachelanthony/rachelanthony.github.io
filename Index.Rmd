...
Its seems that by the 10th April 2020 males were more likely to be killed that females by COVID-19.
...
Weekly.Age <- data.frame(Week_End = c(1,2,3,4,5,6,7),
...
Age01 = ggplot(Weekly.Age, aes(x=Week_End, y=Age1))+
...
Age02 = ggplot(Weekly.Age, aes(x=Week_End, y=Age2))+
...
Age03 = ggplot(Weekly.Age, aes(x=Week_End, y=Age3))+
...
Age04 = ggplot(Weekly.Age, aes(x=Week_End, y=Age4))+
...
Age05 = ggplot(Weekly.Age, aes(x=Week_End, y=Age5))+
...
Age06 = ggplot(Weekly.Age, aes(x=Week_End, y=Age6))+
...
Age07 = ggplot(Weekly.Age, aes(x=Week_End, y=Age7))+
...
Age08 = ggplot(Weekly.Age, aes(x=Week_End, y=Age8))+
...
Age09 = ggplot(Weekly.Age, aes(x=Week_End, y=Age9))+
...
```{r echo=TRUE, error=FALSE, message=FALSE, fig.align='centre', fig.width=5, fig.height=3}
